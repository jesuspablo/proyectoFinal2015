...
<form class="form-horizontal" role="form" action="#" id="asignaturaForm" name="formulario">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" id="nombre" class="form-control"  name="nombre" size="15" placeholder="Título del asignatura" />
        </div>
    </div> 
    <div class="form-group">
        ...
        <div class="col-sm-1">              
            <a class="btn btn-primary btn-sm" id="obj_prefesor_button" href="#"><i class="glyphicon glyphicon-search"></i></a>
        </div>        
    ...
    <div class="form-group">
        ...
        <label class="col-sm-7" for="obj_nota_desc" id="obj_nota_desc"></label>                     
    </div>
    
    <div class="form-group">
        <label class="col-sm-2 control-label" for="obj_nota_id">Nota: </label> 
        <div class="col-sm-2">              
            <input readonly="true"  class="form-control"  id="obj_nota_id" class="input-mini" name="id_nota" type="text" size="5" maxlength="5" />  
        </div>
        
        <div class="col-sm-1">              
            <a class="btn btn-primary btn-sm" id="obj_nota_button" href="#"><i class="glyphicon glyphicon-search"></i></a>
        </div>        
        <label class="col-sm-7" for="obj_nota_desc" id="obj_nota_desc"></label>                     
    </div>
